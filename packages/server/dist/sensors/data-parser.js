...
export class DataParser {
    ...
    sessionManager = null; // Will be injected
    setSessionManager(sessionManager) {
        this.sessionManager = sessionManager;
    }
    parse(rawData, protocol) {
    ...
    calculateQuality(rawData, protocol) {
        ...
        if (protocol === 'ant_plus') {
            ...
            if (rawData.rawData) {
                ...
                if (rawData.rawData.DeviceId === undefined)
                    quality -= 10;
    ...
    validateReading(reading) {
        ...
        if (!reading.metricType || !reading.unit)
            return false;
        if (typeof reading.value !== 'number')
            return false;
        if (reading.quality < 0 || reading.quality > 100)
            return false;
    ...
    extractMetricSpecificData(rawData) {
        const result = {};
